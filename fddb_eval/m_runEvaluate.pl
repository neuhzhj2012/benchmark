...
#### VARIABLES TO EDIT ####
# where gnuplot is
my $GNUPLOT = "/usr/bin/gnuplot-wx"; 
# where the binary is
my $evaluateBin = "./evaluate"; 
# where the images are
my $imDir = "/data1/cv_group/cv_user/huangzhongjie/face-py-faster-rcnn/data/FDDB/originalPics/"; 
# where the folds are
my $fddbDir = "/data1/cv_group/cv_user/huangzhongjie/face-py-faster-rcnn/data/FDDB/FDDB-folds/"; 
# where the detections are
#my $detDir = "../detection/output/fddb_res"; 
my $detDir = "/data1/cv_group/cv_user/huangzhongjie/face-py-faster-rcnn/output/fddb_res"; 
###########################
...
foreach my $fi (1..10){
  my $foldFile = sprintf("%s/FDDB-det-fold-%02d.txt", $detDir, $fi);
